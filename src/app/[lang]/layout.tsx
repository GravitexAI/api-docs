...
> = {
  en: {
    default: 'Gravitex AI - The Foundation of Your AI Universe',
    template: '%s | Gravitex AI',
    description:
  ...
  zh: {
    default: 'Gravitex AI - AI 基座',
    template: '%s | Gravitex AI',
    description:
      '承载所有 AI 应用，管理你的数字资产，连接未来的统一基础设施平台。快速部署，轻松扩展。',
  },
  ja: {
    default: 'Gravitex AI - あなたの AI ユニバースの基盤',
    template: '%s | Gravitex AI',
    description:
...
export async function generateMetadata({
  ...
  return createMetadata({
    ...
    authors: [
      { name: 'Gravitex AI Team', url: 'https://client.gravitex.ai' },
    ],
    creator: 'Gravitex AI Team',
    alternates: {
      languages: {
        en: '/en',
        zh: '/zh',
