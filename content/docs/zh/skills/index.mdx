---
title: Skills — AI 编辑器扩展
description: newapi-skills 是 New API 官方 AI 编辑器 Skill 插件，支持 Claude Code、Cursor、Windsurf 等 AI IDE。通过自然语言指令在编辑器内管理模型、令牌、分组和余额，无需切换窗口。安装简单，一行命令即可完成。
---
