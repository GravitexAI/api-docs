---
title: Skills — AI エディター拡張
description: newapi-skills は New API 公式の AI エディター Skill プラグインです。Claude Code、Cursor、Windsurf などの AI IDE で、自然言語コマンドによりモデル、トークン、グループ、残高を直接管理できます。ワンライナーでインストール完了。
---
