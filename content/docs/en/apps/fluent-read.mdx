...
description: FluentRead configuration guide — open-source browser translation plugin with 20+ engines and AI model support. Connect to Gravitex API for immersive bilingual reading.
---

<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the Gravitex API console, you can add
...
### Import Configuration from Gravitex API Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the Gravitex API console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the Gravitex API configuration in FluentRead will be enabled.
...
| ------------------- | --------------------------------------- |
| Translation Service | Gravitex API                                  |
| Access Token        | Gravitex API Key                              |
| Gravitex API Endpoint     | Gravitex API Deployment Address (without /v1) |
