...
Ratio settings are a core configuration of GravitexApi's internal cost accounting system. By setting different ratios, you can flexibly control internal cost allocation, budget control, or enterprise customer billing standards for various models and user groups.

## Ratio System Overview

GravitexApi uses a three-tier ratio system to calculate user quota consumption:
...
Gravitex API adopts a dual billing mechanism of pre-consumption and post-consumption:
