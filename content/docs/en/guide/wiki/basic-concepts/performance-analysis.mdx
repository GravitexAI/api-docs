...
Gravitex API provides two types of performance analysis capabilities:
...
export PYROSCOPE_APP_NAME=gravitex-api
...
```bash
# Check env vars
docker exec gravitex-api env | grep -E "PPROF|PYROSCOPE"
```
