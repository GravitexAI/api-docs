...
Gravitex API now supports integration with popular analytics platforms to help you track user behavior and website performance:
...
docker exec gravitex-api env | grep -E "GOOGLE_ANALYTICS|UMAMI"
```
