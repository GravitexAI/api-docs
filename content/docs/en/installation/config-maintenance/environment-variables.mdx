...
| `FRONTEND_BASE_URL`               | Frontend base URL (used by slave nodes, redirects unmatched routes to this address) | -             | `FRONTEND_BASE_URL=https://your-domain.xxx` |
...
FRONTEND_BASE_URL=https://your-domain.xxx
