...
This document provides all environment variables supported by Gravitex API and their configuration instructions. You can customize the system's behavior by setting these environment variables.

<Callout type="info" title="Tip">
  Gravitex API supports reading environment variables from `.env` files. Please refer to the `.env.example`
...
| Environment Variable    | Description                                  | Default Value            | Example                                                                                                                             |
| ----------------------- | -------------------------------------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| `SQL_DSN`               | Database Connection String                   | SQLite (data/one-api.db) | MySQL: `SQL_DSN=root:123456@tcp(localhost:3306)/gravitex-api` \| PostgreSQL: `SQL_DSN=postgresql://root:123456@postgres:5432/gravitex-api` |
...
| `SQLITE_PATH`           | SQLite Database Path                         | `/path/to/sqlite.db`     | `SQLITE_PATH=/var/lib/gravitex-api/gravitex-api.db`                                                                                        |
...
| `FRONTEND_BASE_URL`               | Frontend base URL (used by slave nodes, redirects unmatched routes to this address) | -             | `FRONTEND_BASE_URL=https://<your-gravitexapi-domain>` |
...
| `PYROSCOPE_APP_NAME`          | Application name for reporting                 | `gravitex-api`     | `PYROSCOPE_APP_NAME=my-api`  |
...
| `HOSTNAME`                    | Hostname label for reporting                   | `gravitex-api`     | `HOSTNAME=node-1`            |
...
# FRONTEND_BASE_URL=https://<your-gravitexapi-domain>
