...
This document provides a graphical tutorial for deploying Gravitex API using the Baota Panel Docker feature.
...
1. Create a website directory in Baota Panel, such as `/www/wwwroot/gravitex-api`
...
3. Enter Image Name: `calciumion/gravitex-api:latest`
...
6. Fill in the following information:
   - **Container Name**: `gravitex-api` (customizable)
   - **Image**: Select the `calciumion/gravitex-api:latest` image you just pulled
