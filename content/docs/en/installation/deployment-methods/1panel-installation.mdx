...
This document provides a graphical tutorial for deploying Gravitex API using the 1Panel panel.
...
## Step 2: Install Gravitex API

### Search for Applications

<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the Gravitex API application under the [AI] category, and install it.
</Callout>

![1panel-gravitexapi](/assets/1panel/1panel-gravitexapi.jpg)

### Configure Parameters

<Callout type="info" title="Install Application">
  Configure Gravitex API application parameters on the installation page:
</Callout>

- **Name**: The name of the Gravitex API application to be created
- **Version**: Select the version of Gravitex API
- **Port**: The service port for the Gravitex API application
...
![gravitexapi-setting](/assets/1panel/gravitexapi-setting.jpg)

### Confirm Installation

<Callout type="info" title="Confirm Installation">
  Click Confirm to start the installation. The page will automatically redirect to the installed applications list. Wait for the Gravitex API application status to change to Started.
</Callout>

![gravitexapi-start](/assets/1panel/gravitexapi-start.jpg)
...
1. In the 1Panel application list, click the **Parameters** button for the Gravitex API application
...
## Step 4: Access Gravitex API

<Callout type="info" title="Access Application">
  - On the `Installed` page, click `Jump` to enter the Gravitex API WebUI page
  - Before use, it is recommended to set the `Default Access Address` on the `Panel Settings` page
</Callout>

![gravitexapi-visit](/assets/1panel/gravitexapi-visit.jpg)
...
2. Find the Gravitex API application, click the **Upgrade** button
...
- [GitHub Repository](https://github.com/QuantumNous/gravitex-api)