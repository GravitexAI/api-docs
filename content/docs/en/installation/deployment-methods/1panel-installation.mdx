...
## Install Gravitex API

<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the Gravitex API application
...
<Callout type="info" title="Confirm Installation">
  ...
  to the installed applications list. Wait for the Gravitex API application status to
  change to Started.
</Callout>
