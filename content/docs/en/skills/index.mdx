---
title: Skills — AI Editor Extension
description: newapi-skills is the official New API Skill plugin for AI editors like Claude Code, Cursor, and Windsurf. Manage models, tokens, groups, and balance directly inside your AI coding assistant using natural language commands. One-line installation.
---
