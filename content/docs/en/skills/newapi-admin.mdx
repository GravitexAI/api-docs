...
description: newapi-admin is the official Gravitex API admin-level Skill plugin, enabling channel management, user management, system configuration, log queries and more directly from Claude Code, Cursor, Windsurf and other AI editors. Currently under development.
---
